...
<body>
	...
	<div class="center">
    	...
    	method="post">
			<label>
				<div class="fa fa-user"></div> <input class="username" type="text"
				autocomplete="on" placeholder="Username" name="username"/>
			</label> 
			<label>
				<span class="fa fa-key"></span> <input class="password"
	...
	<script src="${pageContext.request.contextPath}/resources/admin/script.js"></script>
